...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GithubProject.project'
        db.add_column(u'oauth_githubproject', 'project',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='github_origin', null=True, to=orm['projects.Project']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GithubProject.project'
        db.delete_column(u'oauth_githubproject', 'project_id')
    ...
    models = {
        ...
        u'oauth.githubproject': {
            ...
            'project': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'github_origin'", 'null': 'True', 'to': u"orm['projects.Project']"}),
            'pub_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'ssh_url': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
